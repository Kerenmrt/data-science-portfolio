...
The overall data pipeline follows a typical data warehousing architecture:
...
### Extract
Data is extracted from multiple academic datasets and loaded into **staging tables**.
